...
namespace cop3530
{
	...
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	BSTRoot<K,V,C,E>::BSTRoot(K key, V value)
	:numNodes(0), root(new_node(key, value))
	{
	}
	
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	void BSTRoot<K,V,C,E>::insert_at_root(Node * in, K key, V value)//insert in O(log n)
	{
		if(!root){
	...
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	void BSTRoot<K,V,C,E>::insert(K key, V value)//insert in O(log n)
	{
		insert_at_root(root,key, value);
		update_heights(root);
	}
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	typename cop3530::BSTRoot<K,V,C,E>::Node * BSTRoot<K,V,C,E>::goto_insert(K key, Node * in)//insert in O(log n)
	{
		while(in)
		{
			if(E(key,in->key))
	...
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	typename cop3530::BSTRoot<K,V,C,E>::Node * BSTRoot<K,V,C,E>::find_iop(K key, Node * in)//insert in O(log n)
	{
		Node *ptr=in;
	...
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	bool BSTRoot<K,V,C,E>::contains(K key)
	{
		Node *ptr= root;
		while(ptr!=nullptr)
		{
	...
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	bool BSTRoot<K,V,C,E>::is_empty(void)
	{
		return root==0;
	}
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	bool BSTRoot<K,V,C,E>::is_full(void)
	{
		return root!=0;
	}
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	unsigned int BSTRoot<K,V,C,E>::size(void)
	{
		return numNodes;
	}
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	unsigned int BSTRoot<K,V,C,E>::height(void)
	{
		update_heights(root);
		return root->height;
	}
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	int BSTRoot<K,V,C,E>::balance(void)
	{
		update_heights(root);
		return (root->left->height)-(root->right->height);//returns balance factor
	}
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	void BSTRoot<K,V,C,E>::clear(void)
	{
		while(!is_empty())
			remove(root->key);
	}
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	int BSTRoot<K,V,C,E>::update_heights(Node * in)
	{
		if(in==nullptr)
			return 0;
		if(in->left&&in->right)
	...
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	void BSTRoot<K,V,C,E>::print(void)	
	{
		if(!root){
			std::cout<<"Map is empty";
		}
	...
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	void BSTRoot<K,V,C,E>::print(Node * in)
	{
		if(in==nullptr)
			return;
		print(in->left);
	...
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	void BSTRoot<K,V,C,E>::delete_node(Node * del)
	{
		Node * ptr=root;
		while(ptr!=del)
		{
	...
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	typename cop3530::BSTRoot<K,V,C,E>::Node * BSTRoot<K,V,C,E>::new_node(K key, V value)
	{
		Node* ptr=new Node;
		ptr->key=key;
		ptr->value=value;
	...
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	void  BSTRoot<K,V,C,E>::swap(Node* parent, Node* child)
	{
		Node * tmp=new Node;
		tmp->key=parent->key;
	...
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	void  BSTRoot<K,V,C,E>::rotate_left(Node*& in)
	{
		if(!in->left)
			return;
		Node * ptr=in;
	...
	template <typename K, typename V, bool (*C)(K &, K &), bool (*E)(K &, K &) >
	void  BSTRoot<K,V,C,E>::rotate_right(Node*& in)
	{
		if(!in->right)
			return;
		Node * ptr=in;
